...
cite_dot <- ggplot(data = cy, aes(Year, Count, group = 1)) + geom_point(color = "#F8766D", size = 4) + geom_line(color = "#F8766D") + labs(Year = "Year", y = "Citations", title = "Citations By Year") + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"), legend.position="none") + scale_x_continuous(breaks=seq(min(cy$Year), max(cy$Year), by = k))
...
pub_dot <- ggplot(data = yr, aes(Year, Count, group = 1)) + geom_point(color = "#619CFF", size = 4) + geom_line(color = "#619CFF") + labs(x = "Year", y = "Publications", title = "Publications By Year") + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"), legend.position="none") + scale_x_continuous(breaks=seq(min(yr$Year), max(yr$Year), by = k))
